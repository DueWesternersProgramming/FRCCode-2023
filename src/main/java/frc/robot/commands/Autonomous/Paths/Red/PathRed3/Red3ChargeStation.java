...
public class Red3ChargeStation extends SequentialCommandGroup {
     ...
     * @param m_turret
     */
    public Red3ChargeStation(DriveSubsystem m_drive, ArmSubsystem m_arm, ArmBaseSubsystem m_armBase, ClawSubsystem m_claw, TurretSubsystem m_turret) {
        addCommands(
