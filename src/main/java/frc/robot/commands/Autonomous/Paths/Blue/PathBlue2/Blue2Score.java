...
public class Blue2Score extends SequentialCommandGroup {
     ...
     * @param m_turret
     */
    public Blue2Score(DriveSubsystem m_drive, ArmSubsystem m_arm, ArmBaseSubsystem m_armBase, ClawSubsystem m_claw, TurretSubsystem m_turret) {
        addCommands(
            new PrintCommand("Blue 2 Score")
        );
