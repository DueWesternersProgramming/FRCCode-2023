...
public class Blue2ChargeStation extends SequentialCommandGroup {
     ...
     * @param m_turret
     */
    public Blue2ChargeStation(DriveSubsystem m_drive, ArmSubsystem m_arm, ArmBaseSubsystem m_armBase, ClawSubsystem m_claw, TurretSubsystem m_turret) {
        addCommands(
          new PrintCommand("Blue 2 Charge Station")
        );
