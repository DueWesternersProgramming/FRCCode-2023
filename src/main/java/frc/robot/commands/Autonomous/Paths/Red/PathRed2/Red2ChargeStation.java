...
public class Red2ChargeStation extends SequentialCommandGroup {
     ...
     * @param m_turret
     */
    public Red2ChargeStation(DriveSubsystem m_drive, ArmSubsystem m_arm, ArmBaseSubsystem m_armBase, ClawSubsystem m_claw, TurretSubsystem m_turret) {
        addCommands(
