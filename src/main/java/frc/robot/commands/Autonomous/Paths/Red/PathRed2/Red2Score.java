...
public class Red2Score extends SequentialCommandGroup {
     ...
     * @param m_turret
     */
    public Red2Score(DriveSubsystem m_drive, ArmSubsystem m_arm, ArmBaseSubsystem m_armBase, ClawSubsystem m_claw, TurretSubsystem m_turret) {
        addCommands(
