...
public class Blue1Score extends SequentialCommandGroup {
     ...
     * @param m_turret
     */
    public Blue1Score(DriveSubsystem m_drive, ArmSubsystem m_arm, ArmBaseSubsystem m_armBase, ClawSubsystem m_claw, TurretSubsystem m_turret) {
        addCommands(
            new PrintCommand("Blue 1 Score")
        );
