...
public class Blue3ChargeStation extends SequentialCommandGroup {
     ...
     * @param m_turret
     */
    public Blue3ChargeStation(DriveSubsystem m_drive, ArmSubsystem m_arm, ArmBaseSubsystem m_armBase, ClawSubsystem m_claw, TurretSubsystem m_turret) {
        addCommands(
          new PrintCommand("Blue 3 Charge Station")
        );
