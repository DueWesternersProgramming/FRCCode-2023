...
public class PathSides extends SequentialCommandGroup {
    ...
    public PathSides(DriveSubsystem m_drive, ArmSubsystem m_arm, IntakeSubsystem m_intake, WristSubsystem m_wrist, LightSubsystem m_light, VisionSubsystem m_vision) {
        addCommands(
            ...
            new WaitCommand(0.5),
            new ParallelCommandGroup(new DriveDistance(m_drive, 55, 0.3), new SetVisionPipeline(m_vision, 0), new SequentialCommandGroup(new IntakeOn(m_intake), new WristUnlatch(m_wrist), new WaitCommand(0.15),
            ...
            new DriveDistance(m_drive, 8, 0.05),
            new WristIn(m_wrist),
